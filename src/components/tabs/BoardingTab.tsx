        ...
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <p className="text-xs text-[#5C7457]">
              چک‌لیست وظایف روتین، ثبت یادداشت صوتی و عکس گزارش برای سرپرستان
            </p>
          </div>
        </div>
                      ...
                      >
                        ...
                        <div className="flex items-center gap-1.5">
                          ...
                          <button
                            ...
                            title="ثبت یادداشت صوتی و عکس برای سرپرست حیوان"
                          >
          ...
          <div className="bg-white text-[#2D3A27] w-full max-w-lg rounded-[32px] shadow-2xl border border-[#E6E9DF] overflow-hidden flex flex-col">
            ...
            <form onSubmit={handleCreateAdmission} className="p-6 space-y-4 text-xs bg-white">
              <div>
                ...
                <RemotePetSearchSelect value={admitForm.petId} onChange={(value) => setAdmitForm({ ...admitForm, petId: value })} pets={pets} className="w-full bg-[#F7F8F3] border border-[#E6E9DF] rounded-xl px-3 py-2.5 text-[#2D3A27] font-bold" />
              </div>
